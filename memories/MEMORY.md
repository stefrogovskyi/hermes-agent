...
§
Windows: pythonw CREATE_NO_WINDOW. Servarica 500GB: NEVER copy/backup 5TB+ files from user PCs, hold ONLY FTS5 index, fetch on-demand. Fallback chain: free models FIRST, paid models LAST.
§
