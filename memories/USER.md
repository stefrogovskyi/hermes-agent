...
§
FILES: Google Drive (API), PC/Desktop (Tailscale if on, send via Telegram).
§
GROUP CHAT: Agents respond to any user via @tag, name, or direct reply. Bot-to-bot replies blocked.
§
User prefers responses in Russian language.
§
