...
draft_words = tokenize(draft_text)
...
draft_6grams = set(get_ngrams(draft_words, 6))

common_6grams = orig_6grams.intersection(draft_6grams)
print("Common 6-grams count:", len(common_6grams))
for g in common_6grams:
    print(" 6-gram:", " ".join(g))

# Also check n-grams for n=5, 6, 7, etc.
