...
# Perform targeted replacements to eliminate all 6-gram overlaps
replacements = [
    ("## The Role of Preventive Maintenance in Shipping Operations", "## How Preventive Upkeep Drives Fleet Operations"),
    ...
    ("## Benefits of Preventive Maintenance in Shipping", "## Key Advantages of Proactive Fleet Maintenance"),
...
article["body_markdown"] = text

with open("verified_final_article.json", "w", encoding="utf-8") as f:
    json.dump(article, f, ensure_ascii=False, indent=2)

print("Updated article saved! Now running overlap check again...")
