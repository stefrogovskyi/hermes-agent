text = """TITLE: Prevent Freight Delays: Strategies for Reliable Delivery
...
Responding quickly to problems prevents missed deadlines. Set up alerts for shipment exceptions, such as delays, damaged goods, or route changes, and assign a team member to monitor shipments and take action.
...
with open('draft2.md', 'w', encoding='utf-8') as f:
    f.write(text)

print("Saved draft2.md")
