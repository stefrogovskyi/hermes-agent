...
with open('/opt/hermes/profiles/richard/Navo24_LinkedIn_Outreach_Playbook.md', 'w', encoding='utf-8') as f:
    ...
    f.write('> 200 целевых ЛПР с проверенными страницами компаний и прямым переходом во вкладку сотрудников в LinkedIn.\n\n---\n\n')
    ...
    for r in rows:
        ...
        f.write(f"- **🏢 LinkedIn Company Page:** {comp_url}\n")
        f.write(f"- **🎯 Direct People Tab:** {people_url}\n")
