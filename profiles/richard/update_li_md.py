...
with open('/opt/hermes/profiles/richard/Navo24_LinkedIn_Outreach_Playbook.md', 'w', encoding='utf-8') as f:
    ...
    f.write('> 100% ВЕРИФИЦИРОВАННЫЕ ПРОФИЛИ ЧЕРЕЗ B2B-API (HUNTER.IO & SNOV.IO) С УНИКАЛЬНЫМИ СЛАГАМИ.\n\n---\n\n')
    ...
    for r in rows:
        ...
        f.write(f"- **👤 DIRECT Personal Profile (Verified):** {direct_url}\n")
...
print(f"LinkedIn Playbook written successfully with {len(rows)} leads!")
