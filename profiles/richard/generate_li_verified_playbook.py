...
with open('/opt/hermes/profiles/richard/Navo24_LinkedIn_Outreach_Playbook.md', 'w', encoding='utf-8') as f:
    ...
    f.write('> 100% ПРОВЕРЕННЫЕ ЖИВЫЕ ЛИЧНЫЕ ПРОФИЛИ РУКОВОДИТЕЛЕЙ (https://www.linkedin.com/in/...).\n\n---\n\n')
    ...
    for r in rows:
        ...
        f.write(f"- **👤 DIRECT Personal Profile (100% Live):** {direct_url}\n")
        f.write(f"- **Segment:** {cat}\n")
...
print(f"LinkedIn Playbook updated with {len(rows)} verified live personal profiles!")
