...
- `references/playwright-anti-bot-queue-polling.md` — Playwright anti-bot bypassing, WAF resolution, and silent cron watchdog patterns for dynamic queue and slot monitoring.
